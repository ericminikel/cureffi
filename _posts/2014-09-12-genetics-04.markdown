...
| 50 | 0 | 10 | Yes | Cannot be determined |
...
If, on the other hand, *cis1* &ne; YKL051W, and the two are not even linked, you'll also get NPD and TT tetrads. Whether or not ykl051w&Delta;G418<sup>R</sup> is cisplatin resistant, this will still reveal itself phenotypically because tetratypes will contain spores that are neither cisplatin nor geneticin resistant.
