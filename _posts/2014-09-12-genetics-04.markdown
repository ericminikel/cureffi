...
*An earlier version of these notes claimed that one could only compute centromere linkage for two unlinked markers. Apparently this was false. You can compute centromere linkage regardless of whether two markers are linked.*
