...
A. David Housman has proposed the "sink hypothesis", wherein binding peripheral protein seeds with an antibody would result in a net flow of pathogenic seeds out of the brain.
