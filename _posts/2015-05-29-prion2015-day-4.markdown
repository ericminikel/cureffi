...
Dr. Wille started from his early X-ray fiber diffraction experiments in the Prusiner lab [[Wille 2009]], which showed a "meridional reflection" at 4.8&Aring;. He now interprets these data to indicate a 4-rung &beta;-solenoid structure where each PrP molecule occupies 4 rungs and spans a total of 19.6&Aring; along the long axis of the fibril. He then presented some unpublished work applying the same method to a variety of different prion strains. He also noted that non-infectious *in vitro* amyloids give a different structure [[Wan 2015]].
